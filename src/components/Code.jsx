  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-green-700/10 ring-1 ring-inset ring-green-700/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-green-700 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0'
        )}
      >
        Copied!
...
export function CodeGroup({ children, title, ...props }) {
  ...
  return (
    <CodeGroupContext.Provider value={true}>
      <Container
        {...containerProps}
        className="my-6 overflow-hidden shadow-md bg-zinc-600 not-prose rounded-2xl dark:ring-1 dark:ring-white/10"
      >
