    ...
    <div className="relative flex h-12 group">
      ...
      {autocompleteState.status === 'stalled' && (
        <div className="absolute inset-y-0 flex items-center right-3">
          <LoadingIcon className="w-5 h-5 animate-spin stroke-zinc-200 text-zinc-900 dark:stroke-zinc-800 dark:text-green-700" />
        </div>
      )}
    </div>
  )
...
export function Search() {
  ...
  return (
    <div className="hidden lg:block lg:max-w-md lg:flex-auto">
      <button
        type="button"
        className="items-center hidden w-full h-8 gap-2 pl-2 pr-3 text-sm transition bg-white rounded-full text-zinc-500 ring-1 ring-zinc-900/10 hover:ring-zinc-900/20 ui-not-focus-visible:outline-none dark:bg-white/5 dark:text-zinc-400 dark:ring-inset dark:ring-white/10 dark:hover:ring-white/20 lg:flex"
        {...buttonProps}
      >
